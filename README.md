...
- Service-reported lifetime/peak tokens and dated daily totals in the Tokens detail tab, separate from locally scanned thread totals. Explicit million/billion units and a subtotal for the seven most recent reported entries make magnitudes comparable; these entries are not necessarily consecutive days, and missing dates never become zeros. Exact summary counts remain available on hover and to accessibility. Redundant dashboard history cards and tiny table sparklines have been removed.
